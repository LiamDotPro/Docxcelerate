...
**placeholders**. This is your local development artifact — it's what the
preview app shows, and it never needs a service.

## document.json

The upload artifact. It's the same tree, except request-time values are kept as
...
Dynamic nodes carry their prompts instead of text. This is the one you send to
